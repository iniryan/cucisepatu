        ...
        <div class="container-fluid">
            ...
            <div class="row">
                    ...
                    <div class="small-box bg-light">
                        <div class="inner">
                            <div class="input-group">
                                <input type="text" class="form-control" id="search-transaksi" placeholder="Cari Kode Transaksi" />
                ...
                <div class="col-lg-3 col-6 my-lg-3 mb-3">
                    <a class="btn btn-primary p-3" href="<?= base_url('cashier/add_transaksi'); ?>">Tambah Transaksi</a>
                </div>
                <!-- ./col -->
            </div>
            <!-- /.row -->
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php $status_paid = $row['status_paid'];
                                                    if ($status_paid == 2) {
                                                        echo "<div class='btn btn-warning p-2 text-md d-block'>DP 50%</div>";
                                                    }else{
                                                        echo "<div class='btn btn-success p-2 text-md d-block'>Lunas</div>";}
                                                ?>
                                            </td>   
                                            <td>
                                                <a class="btn btn-primary py-2" href="<?= base_url('cashier/detail_transaksi/transaksi/') . $row['transaction_id']; ?>"><i class="fas fa-eye"></i></a>
                                            </td>                                                                 
                                        </tr>
                                        <?php }
                                    } ?>
