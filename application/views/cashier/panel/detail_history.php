											...
											<tr class="text-center">
												...
												<td class="text-left">
													...
													<?php }elseif ($item->status == 4) {?>
														<div class="progress progress-sm">
															<div class="progress-bar bg-success" role="progressbar" aria-volumenow="75" aria-volumemin="0" aria-volumemax="100" style="width: 100%">
															</div>
														</div>
														<small>Telah Diambil</small>
													<?php }?>
												</td>
												<td>
                        ...
                        <div class="row px-4">
                        	...
                        	<!-- /.col -->
                          	<div class="col-4">
                            	...
                            	<input type="text" class="form-control my-2" value="Rp <?=number_format($transaction->total,0,',','.');?>" readonly>
                            	<h6><b>Bayar</b></h6>
                            	<input type="text" class="form-control my-2" value="Rp <?=number_format($transaction->bayar,0,',','.');?>" readonly>
                            	<h6><b>Kembalian</b></h6>
                            	<input type="text" class="form-control my-2" value="Rp <?=number_format($transaction->kembalian,0,',','.');?>" readonly>
                          	</div>                          
                        </div>
                        <!-- /.row -->
                    </div>
