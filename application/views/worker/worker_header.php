...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-light-primary elevation-4">
    ...
    <div class="text-center">
      <a href="<?= base_url('worker/dashboard'); ?>"><img src="<?= base_url('assets/adminlte/dist/img/logocs(5).png'); ?>" class="m-3" width="200px" alt="Directory logo"></a>
    </div>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 text-center">
        ...
        <div class="info">
          <a href="<?= base_url('worker/dashboard'); ?>">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="<?= base_url('worker/dashboard');?>" class="nav-link <?= activate_menu('dashboard')?>">
          ...
          <li class="nav-item">
            <a href="<?= base_url('worker/history'); ?>" class="nav-link <?= activate_menu('history')?>">
