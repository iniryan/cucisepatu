                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <?php }elseif ($row['status'] == 3) {?>
                                                                    ...
                                                                    <?= $row['delivery']==0?'<small>Menunggu Pengambilan</small>':'<small>Sedang Diantar</small>';?>
                                                                <?php }?>
                                                            </td>
                                                            <td>                                                        
                                                                <button class="btn btn-primary" data-id="<?= $row['detail_transaction_id']?>" data-name='btn-detail-sepatu'><i class="fas fa-eye"></i></button>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button id="btn-update" class="btn btn-md float-right text-bold">Ganti Status</button>
                    <!-- <button id="btn-update" data-idstatus="" class="btn btn-md btn-green float-right text-bold">Ganti Status</button>
                    <button id="btn-update" data-idstatus="" class="btn btn-md btn-primary float-right text-bold">Ganti Status</button> -->
                </div>
            </div>
            <!-- /.modal-content -->
        </div>
